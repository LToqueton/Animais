  ...
  return (
    <nav className="nav">
      ...
      <ul className={active}>
        ...
        <li className="nav__item">
          <Link to="/quem-somos" className="nav__link">Quem somos</Link>
        </li>
        <li className="nav__item">
          <Link to="/quero-adotar" className="nav__link">Quero Adotar</Link>
        </li>
        <li className="nav__item">
